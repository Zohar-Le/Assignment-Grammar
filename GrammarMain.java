...
public class GrammarMain {
    ...
    public static void welcome() {
        System.out.println("Welcome to the CS 145 random sentence generator!");
        System.out.println();
    ...
    public static List<String> readLines(String fileName){
        ...
        catch (Exception e) {System.out.println("File Not found : " + e); System.exit(-1);}        
